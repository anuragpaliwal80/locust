...
def request_stats():
    ...
    for s in chain(sort_stats(runners.locust_runner.request_stats), [runners.locust_runner.stats.total]):
        stats.append({
            ...
            "min_server_processing" : s.http_stats.min_server_processing,
            "max_server_processing" : s.http_stats.max_server_processing,
            "min_dns_lookup" : s.http_stats.min_dns_lookup,
            "max_dns_lookup" : s.http_stats.max_dns_lookup,
            "min_tcp_connection" : s.http_stats.min_tcp_connection,
            "max_tcp_connection" : s.http_stats.max_tcp_connection,
            "min_pre_transfer" : s.http_stats.min_pre_transfer,
            "max_pre_transfer" : s.http_stats.max_pre_transfer,
            "min_connect" : s.http_stats.min_connect,
            "max_connect" : s.http_stats.max_connect,
            "min_start_transfer" : s.http_stats.min_start_transfer,
            "max_start_transfer" : s.http_stats.max_start_transfer,
            "min_tls_handshake" : s.http_stats.min_tls_handshake,
            "max_tls_handshake" : s.http_stats.max_tls_handshake,
            "min_name_lookup" : s.http_stats.min_name_lookup,
            "max_name_lookup" : s.http_stats.max_name_lookup,
        })
